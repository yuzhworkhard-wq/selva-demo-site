...
let projects = [
  {
    ...
    folders: [
      ...
      { id: 102, name: '产品介绍', visibility: 'shared', owner: 'u1', members: ['u1', 'u2', 'u4', 'u6', 'u8'], files: [
        ...
        { name: '消除竖版_u6_001.mp4', type: 'video', status: 'done', time: '1 天前', creator: 'u6', taskId: 'T-20260414-102', thumbHue: 170, thumbScene: '品牌竖版 · grok 1.5', duration: '00:15', tags: ['grok 1.5','竖版'] },
        { name: '赚钱品牌_u6.mp4', type: 'video', status: 'done', time: '4 天前', creator: 'u6', taskId: 'T-20260410-102', thumbHue: 200, thumbScene: '赚钱品牌 · grok 1.5', duration: '00:20', tags: ['grok 1.5','品牌'] },
  ...
  },
  {
    ...
    folders: [
      ...
      { id: 402, name: '海外视频', visibility: 'shared', owner: 'u3', members: ['u3', 'u7', 'u10', 'u13'], files: [
        { name: '海外_grok_u3_001.mp4', type: 'video', status: 'done', time: '2 天前', creator: 'u3', taskId: 'T-20260412-201', thumbHue: 190, thumbScene: '海外投放 · grok 1.5', duration: '00:20', tags: ['海外','grok 1.5'] },
        ...
        { name: '品牌_grok_u10_001.mp4', type: 'video', status: 'done', time: '7 天前', creator: 'u10', taskId: 'T-20260407-101', thumbHue: 230, thumbScene: '品牌推广 · grok 1.5', duration: '00:15', tags: ['品牌','grok 1.5'] },
        { name: '品牌_grok_u10_002.mp4', type: 'video', status: 'done', time: '7 天前', creator: 'u10', taskId: 'T-20260407-101', thumbHue: 245, thumbScene: '品牌推广 · grok 1.5 B', duration: '00:15', tags: ['品牌','grok 1.5'] },
      ]},
    ]
  },
  {
    ...
    folders: [
      { id: 501, name: '增长视频', visibility: 'shared', owner: 'u9', members: ['u9', 'u11', 'u12', 'u14'], files: [
        ...
        { name: '增长B_u12_001.mp4', type: 'video', status: 'done', time: '9 天前', creator: 'u12', taskId: 'T-20260405-001', thumbHue: 175, thumbScene: '增长B组 · grok 1.5', duration: '00:15', tags: ['增长','grok 1.5'] },
        { name: '增长B_u12_002.mp4', type: 'video', status: 'done', time: '9 天前', creator: 'u12', taskId: 'T-20260405-001', thumbHue: 180, thumbScene: '增长B组 · grok 1.5 B', duration: '00:15', tags: ['增长','grok 1.5'] },
        { name: '增长测试_u11_001.mp4', type: 'video', status: 'done', time: '17 天前', creator: 'u11', taskId: 'T-20260328-101', thumbHue: 200, thumbScene: '增长测试 · grok 1.5', duration: '00:15', tags: ['增长','grok 1.5'] },
      ]},
      { id: 502, name: '增长脚本', visibility: 'shared', owner: 'u9', members: ['u9', 'u11', 'u12', 'u14'], files: [
        ...
        { name: 'veo31增长_u8_202.mp4', type: 'video', status: 'done', time: '1 天前', creator: 'u8', taskId: 'T-20260413-202', thumbHue: 260, thumbScene: '增长测试 · Google omni', duration: '00:16', tags: ['增长','Google omni'] },
      ]},
    ]
  },
];
