...
const REGION_LABELS = {
  ar: '阿根廷', au: '澳大利亚', br: '巴西', ca: '加拿大', cl: '智利', co: '哥伦比亚',
  de: '德国', ec: '厄瓜多尔', fr: '法国', id: '印度尼西亚', jp: '日本', ke: '肯尼亚',
  kr: '韩国', lk: '斯里兰卡', mx: '墨西哥', my: '马来西亚', ng: '尼日利亚', nz: '新西兰',
  pe: '秘鲁', ph: '菲律宾', pk: '巴基斯坦', th: '泰国', tr: '土耳其', tw: '中国台湾',
  uk: '英国', us: '美国', uy: '乌拉圭', vn: '越南', za: '南非',
};
const REGION_BANK_KEYS = { id: '印尼' };
const REGION_LANGUAGES = {
  阿根廷: '西班牙语', 澳大利亚: '英语', 巴西: '葡萄牙语', 加拿大: '英语', 智利: '西班牙语',
  哥伦比亚: '西班牙语', 德国: '德语', 厄瓜多尔: '西班牙语', 法国: '法语', 印度尼西亚: '印尼语',
  日本: '日语', 肯尼亚: '斯瓦希里语', 韩国: '韩语', 斯里兰卡: '僧伽罗语', 墨西哥: '西班牙语',
  马来西亚: '马来语', 尼日利亚: '英语', 新西兰: '英语', 秘鲁: '西班牙语', 菲律宾: '菲律宾语',
  巴基斯坦: '乌尔都语', 泰国: '泰语', 土耳其: '土耳其语', 中国台湾: '中文', 英国: '英语',
  美国: '英语', 乌拉圭: '西班牙语', 越南: '越南语', 南非: '英语', 印尼: '印尼语', 印度: '印地语',
};
